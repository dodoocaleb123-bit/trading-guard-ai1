...
describe("approved Telegram signal formatting", () => {
  ...
  it("renders the requested compact signal format", () => {
    ...
    expect(message).toBe(["SELL", "EUR/USD · 1H", "Entry: 1.16736", "Stop loss: 1.16876", "Take profit: 1.16456", "Risk/reward: 1:2", "Confidence: 84% · Confluence: 80%", "Score: BUY 2 vs SELL 8", "Paper only · UNVALIDATED · HIERARCHICAL WORKFLOW · ENTRY LOCATOR"].join("\n"));
